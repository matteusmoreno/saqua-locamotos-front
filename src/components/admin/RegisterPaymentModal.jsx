          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Confirmar recebimento de <span className="text-brand-gold font-bold">{formatCurrency(payment.amount)}</span>
              </p>
            </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-bold bg-brand-gold hover:bg-brand-gold-hover text-black-pure transition-all disabled:opacity-50"
              >
